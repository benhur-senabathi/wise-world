...
export const businessRecipients: Recipient[] = [
  ...
  { id: 104, name: 'Benhur Senabathi', subtitle: 'Wise account', avatarType: 'photo', avatarSlug: 'connor-berry', hasFastFlag: true },
...
export const businessRecentContacts = [
  ...
  { name: 'Benhur Senabathi', subtitle: 'Wise account', imgSrc: 'https://www.tapback.co/api/avatar/connor-berry.webp', badge: { icon: <FastFlag size={16} />, type: 'action' as const } },
];
