...
export const youngExplorerTransactions: Transaction[] = [
  { name: 'From GBP', subtitle: 'Added by Benhur Senabathi', amount: '+ 50.00 GBP', isPositive: true, icon: <Plus size={24} />, date: '1 May', currency: 'GBP' },
  ...
  { name: 'From GBP', subtitle: 'Added by Benhur Senabathi', amount: '+ 20.00 GBP', isPositive: true, icon: <Plus size={24} />, date: '10 May', currency: 'GBP' },
